SHOW DATABASES;
-- Muestra de la bases de datos que existen
...
CREATE TABLE IF NOT EXISTS tabla_test1 (variable_1 VARCHAR(10));

CREATE TABLE IF NOT EXISTS tabla_test2 (variable_2 VARCHAR(10));

DESCRIBE tabla_test1;
-- Descripcion de los atributos de la tabla
DESCRIBE tabla_test2;

-- Comentar tablas
ALTER TABLE tabla_test1 COMMENT "ESTA ES UNA PRIMERA TABLA DE PRUEBA";

SHOW CREATE TABLE tabla_test1;
-- Ver los comentarios hechos sobre las tablas
-- Para ver todos los comentarios sobre la base de datos
SELECT DATABASE();
-- Me muestra en la base de datos que me encuentro actualmente
...
SELECT '5' * '5' error;
-- error por que texto por texto no puede ejecutarse
...
SELECT ENDS_WITH (
        'c:/ruta/archivo/bootcamp.pdf', 'pdf'
    ) ruta
SELECT ENDS_WITH (
        'c:/ruta/archivo/bootcamp.pdf', 'csv'
    ) ruta
...
-- bigint
SELECT
    9223372036854775807 AS num_bigint_positivo,
    -9223372036854775807 num_bigint_negativo;

-- numeric
SELECT
    999999999999999.999 AS num_numeric_positivo,
    -999999999999999.999 num_numeric_negativo;
-- float
SELECT
    1.7976931348623157E308 AS num_float_positivo,
    -1.7976931348623157E308 num_float_negativo;

-- integer
SELECT
    2147483647 AS num_integer_positivo,
    -2147483647 num_integer_negativo;

-- smallint
SELECT
    32767 AS num_smallint_positivo,
    -32767 num_smallint_negativo;

-- tinyint
SELECT 127 AS num_tinyint_positivo, -127 num_tinyint_negativo;

--hugeint
SELECT
    170141183460469231731687303715884105727 AS num_hugeint_positivo,
    -170141183460469231731687303715884105727 num_hugeint_negativo;
-- booleanos
SELECT TRUE verdadero, FALSE falso;
...
ALTER TABLE tabla1
MODIFY COLUMN atributo1 VARCHAR(5) COMMENT 'Comentario 1 de atributo';
...
-- CAMBIO DEL MOTOR DE ALMACENAMIENTO DE LAS TABLAS
CREATE TABLE IF NOT EXISTS tabla_prueba2 (
    ID INT NOT NULL,
    Nombre VARCHAR(100)
) ENGINE = MEMORY;
